            ...
            <div class="search-box-wrapper">
                <div class="search-box container">
                    <ul class="search-tabs clearfix">
                        ...
                        <li><a href="#bus-tab" data-toggle="tab">BUS</a></li>
                        <li><a href="#train-tab" data-toggle="tab">TRAIN</a></li>
                        <li><a href="#taxi-tab" data-toggle="tab">TAXI</a></li>
                        <li><a href="#cars-tab" data-toggle="tab">CAR HIRE</a></li>
                        <li><a href="#events-tab" data-toggle="tab">EVENTS</a></li>
                        <li><a href="#flight-status-tab" data-toggle="tab">CHECK STATUS</a></li>
                        <li><a href="#online-checkin-tab" data-toggle="tab">REQUEST REFUND</a></li>
                    </ul>
                    <div class="visible-mobile">
                        <ul id="mobile-search-tabs" class="search-tabs clearfix">
                            <li class="active"><a href="#hotels-tab">HOTELS</a></li>
                            <li><a href="#flights-tab">FLIGHTS</a></li>
                            <li><a href="#bus-tab">BUS</a></li>
                            <li><a href="#train-tab">TRAIN</a></li>
                            <li><a href="#taxi-tab">TAXI</a></li>
                            <li><a href="#cars-tab">CAR HIRE</a></li>
                            <li><a href="#events-tab">EVENTS</a></li>
                            <li><a href="#flight-status-tab">CHECK STATUS</a></li>
                            <li><a href="#online-checkin-tab">REQUEST REFUND</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="col-sms-6 col-sm-6 col-md-3">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInDown" data-animation-duration="1">
                                    <a href="ajax/slideshow-popup.html" title="" class="hover-effect popup-gallery"><img src="images/270x160.png" alt="" width="270" height="160" /></a>
                                </figure>
                                <div class="details">
            ...
            <div class="honeymoon section global-map-area promo-box parallax" data-stellar-background-ratio="0.5">
                <div class="container">
                    <div class="col-sm-6 content-section description pull-right">
                        ...
                        <div class="row places image-box style9">
                                ...
                                <article class="box">
                                    <figure>
                                        <a href="hotel-list-view.html" title="" class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp" data-animation-duration="1">
                                            <img src="images/170X170.png" alt="" /></a>
                                    </figure>
                                    <div class="details">
                            ...
                            <div class="col-xs-4">
                                <article class="box">
                                    <figure>
                                        <a href="hotel-list-view.html" title="" class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp" data-animation-duration="1" data-animation-delay="0.4"><img src="images/170X170.png" alt="" /></a>
                                    </figure>
                                    <div class="details">
                            ...
                            <div class="col-xs-4">
                                <article class="box">
                                    <figure>
                                        <a href="hotel-list-view.html" title="" class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp" data-animation-duration="1" data-animation-delay="0.8"><img src="images/170X170.png" alt="" /></a>
                                    </figure>
                                    <div class="details">
                    ...
                    <div class="col-sm-6 image-container no-margin">
                        <img src="images/524x540.png" alt="" class="animated" data-animation-type="fadeInUp" data-animation-duration="2">
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1">
                                    <a href="#" title=""><img src="images/270x192.png" alt="" width="270" height="192" /></a>
                                </figure>
                                <div class="details">
                                    <h4>Hire Cars</h4>
                        ...
                        <div class="col-sms-6 col-sm-6 col-md-3">
                            <article class="box">
                                <figure class="middle-block">
                                    <img src="images/300x120.png" alt="" class="middle-item" />
