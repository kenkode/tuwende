<footer id="footer">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <ul class="travel-news">
                                <li>
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="images/63x63.png" alt="" width="63" height="63" />
                                        </a>
                                    </div>
            ...
            <div class="bottom gray-area">
                <div class="container">
                    <div class="pull-left">
                        <a href="index.html" title="Tuwende - home">
                            <img src="images/favicon.png" alt="Tuwende" style="float: left;" /><h4 style="float: left;">Tuwende</h4>
                        </a>
                    </div>
    ...
    <!-- Google Map Api -->
    <script type='text/javascript' src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en&key= AIzaSyDmAtebwD3F9LVQFcHOluLp0ppKz8CEopk "></script>
